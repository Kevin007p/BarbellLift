...
X = df_train.drop("label", axis=1)  # we want to predict the exercise ( label)
y = df_train["label"]
...
# Changes made: using FeedForwardNN, set gridsearch to false, and using selected_features
(
    class_train_y,
    class_test_y,
    class_train_prob_y,
