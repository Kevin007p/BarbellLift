...
# The time it took to complete the set
...
df_pca = PCA.apply_pca(df_pca, predictor_columns, 3)  # 3 was found from the graph above
...
fs = int(1000 / 200)
ws = int(2800 / 200)  # Average rep is 2.8 seconds
...
for s in df_freq["set"].unique():
    print(f"Applying Fourrier Transformation to set {s}")
...
df_freq = df_freq.iloc[::2]  # Take every other row to prevent overfitting
...
# This is to determine the best k
for k in k_values:
